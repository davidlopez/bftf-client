...
const BoardOfDirectors = (): React.ReactElement => {
  const bods = [
    {
      ...
      origin: "Aurora PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/published/prince-bod.jpg?1653425565",
    },
    {
      ...
      origin: "Aurora PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/williby-machelle_orig.jpg",
    },
    {
      ...
      origin: "Aurora PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/raines-troy_orig.jpg",
    },
    {
      ...
      origin: "Aurora PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/longshore-orig_orig.jpg",
    },
    {
      ...
      origin: "Aurora PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/van-dyk-eugene_orig.jpg",
    },
    {
      ...
      origin: "Thornton PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/e-lucero_orig.jpg",
    },
    {
      ...
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/tommy-barella_orig.jpg",
    },
    {
      ...
      origin: "Douglas County SD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/published/teylana.jpeg?1653425927",
    },
    {
      ...
      origin: "Aurora PD",
      image:
        "http://www.brotherhoodcolorado.org/uploads/3/4/9/4/34944272/published/jeffrey.jpg?1653425569",
    },
  ];
    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      {bods.map((bod) => (
        <div className="card card-side bg-secondary-focus flex max-h-64 min-h-64 grow items-center overflow-hidden rounded-lg bg-dm-foreground/60 shadow-xl">
          <img
            className="min-h-full w-1/3 object-cover"
            src={bod.image}
            alt="pbod"
          />
